...
<body>
        ...
        <form method="POST" action="update_user.php?id=<?php echo $id; ?>">
                <label>Category ID:</label><input type="text" value="<?php echo $row['username']; ?>" name="username">
                <label>Category Name:</label><input type="text" value="<?php echo $row['password']; ?>" name="password"><br><br>
